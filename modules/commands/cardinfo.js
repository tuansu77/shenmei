...
module.exports.run = async function ({ api, event, args, Users }) {
  ...
  if(event.type == "message_reply") { uid = event.messageReply.senderID }
    ...
    const res = await axios.get(`https://api.leanhtruong.net/v2/info_user_facebook.php?api_key=LEANHTRUONG=yNxkVwLiQC3azZ8TgkByZe0fRnDAVNkVKvOguwyCVDQjbLyJU20T25HhNiru33WBVuT11WmvN6kNf3PR9c4CcCSZp1YOvXGJDuhJ=APIKEY=PLANFREE&id=${uid}`); 
